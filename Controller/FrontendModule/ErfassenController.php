...
namespace Pnwscm60\ContaoPbworkBundle\Controller\FrontendModule;
...
/**
 * Class ErfassenController
 *
 * @FrontendModule(ErfassenController::TYPE, category="pbwork", template="mod_erfassen")
 */
class ErfassenController extends AbstractFrontendModuleController
{
    public const TYPE = 'erfassen';
